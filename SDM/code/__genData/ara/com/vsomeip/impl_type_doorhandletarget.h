#ifndef __ARA_COM_VSOMEIP__DOORHANDLETARGET_H__
#define __ARA_COM_VSOMEIP__DOORHANDLETARGET_H__
...
/*
	DoorHandleTarget() {}
	~DoorHandleTarget() {}
	DoorHandleTarget(const std::uint8_t _FrontLeftDoor,const std::uint8_t _FrontRightDoor,const std::uint8_t _RearLeftDoor,const std::uint8_t _RearRightDoor,const std::uint8_t _Reserved4,const std::uint8_t _Reserved3,const std::uint8_t _Reserved2,const std::uint8_t _Reserved1):FrontLeftDoor(_FrontLeftDoor),FrontRightDoor(_FrontRightDoor),RearLeftDoor(_RearLeftDoor),RearRightDoor(_RearRightDoor),Reserved4(_Reserved4),Reserved3(_Reserved3),Reserved2(_Reserved2),Reserved1(_Reserved1) {}
	DoorHandleTarget(const DoorHandleTarget &_x){
	...
	DoorHandleTarget(DoorHandleTarget &&_x){
	...
	DoorHandleTarget& operator=(const DoorHandleTarget &_x){
		FrontLeftDoor = _x.FrontLeftDoor;
		FrontRightDoor = _x.FrontRightDoor;
		RearLeftDoor = _x.RearLeftDoor;
		RearRightDoor = _x.RearRightDoor;
	...
	DoorHandleTarget& operator=(DoorHandleTarget &&_x){
		FrontLeftDoor = std::move(_x.FrontLeftDoor);
		FrontRightDoor = std::move(_x.FrontRightDoor);
		RearLeftDoor = std::move(_x.RearLeftDoor);
		RearRightDoor = std::move(_x.RearRightDoor);
...
#endif //__ARA_COM_VSOMEIP__DOORHANDLETARGET_H__
