#ifndef ____BDCOTA_H__
#define ____BDCOTA_H__
...
/*
	...
	BDCOTA& operator=(const BDCOTA &_x){
		IPS_DCDCModeSt = _x.IPS_DCDCModeSt;
		DCDC_ModeSt = _x.DCDC_ModeSt;
		BMC_DCUBattSt = _x.BMC_DCUBattSt;
		BMS_DCUBattSt = _x.BMS_DCUBattSt;
